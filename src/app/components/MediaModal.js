...
export default function MediaModal({ media, index, onClose, onNavigate }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-15 right-4 md:top-6 md:right-6 w-10 h-10 md:w-12 md:h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors z-10"
      >
